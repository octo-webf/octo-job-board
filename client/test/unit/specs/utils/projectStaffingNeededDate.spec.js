...
describe('Unit | Utils | Project Staffing Needed Date', () => {
  ...
  it('should sort five jobs according to project staffing needed date', () => {
    // Given
    const job1 = { id: 1, project: { staffing_needed_from: '2017-10-04' } };
    const job2 = { id: 2, project: { staffing_needed_from: '2017-10-03' } };
    const job3 = { id: 3, project: { staffing_needed_from: '2017-10-02' } };
    const job4 = { id: 4, project: { staffing_needed_from: '2017-10-01' } };
    const job5 = { id: 5, project: { staffing_needed_from: '2017-10-05' } };
  ...
  it('should sort five jobs with the same date according to project staffing needed date', () => {
    ...
    const job4 = { id: 4, project: { staffing_needed_from: '2017-10-04' } };
    const job2 = { id: 2, project: { staffing_needed_from: '2017-10-04' } };
    const job5 = { id: 5, project: { staffing_needed_from: '2017-10-04' } };
